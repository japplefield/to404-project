...
citi$month <- as.factor(month(citi$startdate))
...
ggplot(combined_gender, aes(x = TAVG, y = count)) + geom_point(size = 2, alpha = 0.5, color = "yellowgreen") + geom_smooth(color = "darkgreen") + facet_wrap( ~ gender)
ggplot(combined_gender, aes(x = TAVG, y = count)) + geom_point(size = 2, alpha = 0.5, color = "yellowgreen") + geom_smooth(color = "darkgreen") + facet_wrap( ~ dayid)
ggplot(combined_gender, aes(x = TAVG, y = dist)) + geom_point(size = 2, alpha = 0.5, color = "yellowgreen") + geom_smooth(color = "darkgreen") 
ggplot(combined_gender, aes(x = TAVG, y = speed)) + geom_point(size = 2, alpha = 0.5, color = "yellowgreen") + geom_smooth(color = "darkgreen") 
