...
```{r}
animatetempchart <- ggplot(citimerged, aes(Date, TAVG, group = month, colour = factor(month))) +
    geom_line() +
    xlab("Date") +
    ylab("Temperature") +
...
#
# citi_ggmap_2 <- citi %>%
#   group_by(day = day, starttime = starttime, lng = start_station_longitude, lat = start_station_latitude,
...
```{r, cache = TRUE}
# citi_ggmap_3 <- citi %>%
#   group_by(day = day, stoptime = stoptime, lng = end_station_longitude, lat = end_station_latitude,
