...
# Cleaning up Data
nyc$neighborhood <- as.factor(neighborhoods)
...
bike_turnover_map <- leaflet(citi_util) %>%
  ...
  addCircleMarkers(
    lng = citi_util$longitude, lat = citi_util$latitude, popup = paste(citi_util$station, "<br>", "Bike Turnover:", round(citi_util$util_rate, 1)),
